...
shutdown(Reason) ->
    ...
    lists:foreach(fun application:stop/1, [roster, rest, n2o, emqttd, kvs, ekka, mochiweb, esockd, gproc]),
    ak.

reboot() ->
    lists:foreach(fun application:start/1, [gproc, esockd, mochiweb, ekka, kvs, emqttd, n2o, rest, roster]).
