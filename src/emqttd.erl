...
shutdown(Reason) ->
    ...
    lists:foreach(fun application:stop/1, [emq_dashboard, roster, bpe, n2o, emqttd, ekka, mochiweb, esockd, gproc]),
    ak.

reboot() ->
    lists:foreach(fun application:ensure_started/1, [gproc, esockd, mochiweb, emqttd, n2o, bpe, roster, emq_dashboard]).
